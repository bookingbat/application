...
abstract class Controller extends AbstractActionController
{
    ...
    function month()
    {
        return $this->params('month') ? $this->params('month') : date('m');
    }

    function year()
    {
        return $this->params('year') ? $this->params('year') : date('Y');
    }
    ...
    {
        return new \Application\Service\DataMapper($this->db());
    }
